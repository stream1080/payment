package com.stream.payment.util;
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.stream.payment");  //设置包名
        ...
        strategy.setInclude("t_order_info","t_payment_info","t_product","t_refund_info");  //生成的表，可接多个参数
